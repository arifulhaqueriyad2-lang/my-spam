...
<body class="py-6 px-4 max-w-xl mx-auto flex flex-col justify-start selection:bg-green-500 selection:text-black">
    ...
    <div class="space-y-6">
        ...
        <div class="cyber-panel">
            <div class="panel-title-bar">
                ...
                <h2 class="neon-text-cyan">ARAFAT ACTIVE PIPELINE</h2>
            </div>
    ...
    <footer class="mt-6 mb-4 text-center text-[11px] font-semibold text-[#a0aec0] tracking-widest uppercase font-poppins">
        System Managed & Engineered By <span class="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-pink-500 font-bold">ARAFAT</span> &copy; 2026
    </footer>
    ...
    <script>
            ...
            return `
                <div id="card-vector-${uid}" class="vector-card flex flex-col gap-2 relative overflow-hidden">
                    ...
                    <div id="expanded-block-${uid}" class="hidden space-y-4 mt-2 transition-all duration-300">
                        ...
                        <div class="glass-card rounded-xl p-4 relative overflow-hidden">
                            <div class="flex items-center gap-2 mb-3">
                                <i class="fa-solid fa-circle-nfo text-green-400 text-xs"></i>
        ...
        async function fetchComprehensiveData(uid) {
            try {
                ...
                document.getElementById(`name-${uid}`).innerText = accInfo.AountName || "Unknown Player";
                    ...
                    if (data.accounts && data.accounts.length) {
                        accListDiv.innerHTML = data.accounts.map(acc => `
                            <div class="text-xs bg-[#0d091f] border border-purple-900/40 px-4 py-3 rounded-full text-gray-300 flex items-center justify-between font-poppins">
                                <span class="flex items-center gap-2"><span class="w-1.5 h-1.5 rounded-full bg-[#00ffcc] shadow-[0_0_6px_#00ffcc]"></span> ARAFAT_NODE</span>
            ...
            fetch(url)
                ...
                .then(data => {
                    if (data.error) {
                        ...
                        showToastNotification('startMessage', `ARAFAT Core Deploy Success: Active`);
